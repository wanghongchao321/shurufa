...
- 中文、中英、中法可用右下角地球键在拼音九键与 26 键间切换；英文使用 QWERTY 直输并配套超过 9800 个英文联想词，法语使用 QWERTY 和超过 4900 个法语候选词库。
- 法语键盘的标点键为擇号，可用于 `J'ai`、`l'homme`、`d'accord` 等连写；Rime 按输入前缀提供候选补全。
- AI 录音中，麦克风图标会随录音峰值调整光圈和大小，以显示当前输入音量。
